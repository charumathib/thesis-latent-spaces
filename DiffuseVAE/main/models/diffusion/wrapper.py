...
from DiffuseVAE.main.models.diffusion.spaced_diff import SpacedDiffusion
from DiffuseVAE.main.models.diffusion.spaced_diff_form2 import SpacedDiffusionForm2
from DiffuseVAE.main.models.diffusion.ddpm_form2 import DDPMv2
from DiffuseVAE.main.util import space_timesteps
...
class DDPMWrapper(pl.LightningModule):
    ...
    def predict_step(self, batch, batch_idx, cond=None, dataloader_idx=None):
        ...
        if self.eval_mode == "sample":
            ...
            img = batch
            # if cond is None:
            #     cond = self.vae.forward_recons(img * 0.5 + 0.5)
