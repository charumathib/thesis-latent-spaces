...
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'~/Downloads/diffvae_cifar10_form2_loss=0.0185.ckpt\' \
#                         dataset.ddpm.evaluation.type='uncond' \
...
python main/eval/ddpm/sample.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.device=\'gpu:0\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'~/Downloads/ddpm_cifar10_uncond_loss=0.0438.ckpt\' \
                        dataset.ddpm.evaluation.type='uncond' \
                        ...
                        dataset.ddpm.evaluation.save_vae=True \
                        dataset.ddpm.evaluation.workers=1 \
                        dataset.vae.evaluation.chkpt_path=\'~/Downloads/vae_cifar10_loss=0.00.ckpt\'
